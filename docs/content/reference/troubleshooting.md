...
Most of these come down to network reality or how pypi serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

pypi rate-limits like any public site. pypi already paces
...
Where a surface is gated, pypi reads a cookie or token you supply
...
`pypi`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what pypi actually did
